...
CREATE TABLE `absencetheacher` (
  ...
  `code_room` varchar(15) NOT NULL,
  `jam_ke` int(13) NOT NULL,
  `materi` varchar(14) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `absencetheacher`
--

INSERT INTO `absencetheacher` (`id`, `nik`, `status`, `class`, `code_room`, `jam_ke`, `materi`, `created_at`) VALUES
(1, 18091989, 'masuk', 'X RPL B', '17A', 1, 'IPA', '2020-11-22 07:09:50');
...
('123123', '12', '12', '21', '12', '12', 'src\\upload\\gambar.jpg', 'src\\upload\\Presentation1.pptx', 12, 18, 4, 'sdf', '123', 'asd', 'ertr', '2001', 'sdf', 'nill', 'sdf', 'sdf', 'sdf', 'wqe', 'eqwe', 'qwe', 'undefined', '2020-11-22 13:42:00', '2020-11-22 13:42:00');
...
INSERT INTO `room` (`id`, `code_room`) VALUES
(1, '17A'),
(2, '17C');
...
--
-- Table structure for table `teachingjurnal`
--

CREATE TABLE `teachingjurnal` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `class` varchar(40) NOT NULL,
  `nameTeacher` varchar(60) NOT NULL,
  `mapel` varchar(40) NOT NULL,
  `codeKD` varchar(40) NOT NULL,
  `subjeckMatter` varchar(40) NOT NULL,
  `information` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `teachingjurnal`
--

INSERT INTO `teachingjurnal` (`id`, `date`, `class`, `nameTeacher`, `mapel`, `codeKD`, `subjeckMatter`, `information`) VALUES
(2, '2020-11-29', 'XI RPL B', 'Ita Megawati', 'WEB', '12.3', 'HTML CSS', 'BOLOS');

-- --------------------------------------------------------

--
-- Table structure for table `uploadlearning`
--

CREATE TABLE `uploadlearning` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
...
--
-- Dumping data for table `uploadlearning`
--

INSERT INTO `uploadlearning` (`id`, `date`, `upload`, `role`) VALUES
(2, '2020-12-01', 'gambar.jpg', 1),
(3, '2020-12-01', 'gambar.jpg', 2);
...
CREATE TABLE `users` (
  ...
  `role` int(2) NOT NULL,
  `letter` varchar(12) NOT NULL,
  `majors` varchar(34) DEFAULT NULL,
...
(1, 'Ismoyo', 'RPL', NULL, 1, '2010212', 'RPL', '09001343', '2020-10-18 03:41:37', '2020-10-18 03:41:37'),
(2, 'setya', 'X', NULL, 0, 'A', 'AKL', '0123213', '2020-10-18 03:41:37', '2020-10-18 03:41:37'),
(3, 'Tim Sim', 'MAT', NULL, 1, '1111', '', '20202019', '2020-10-22 03:14:15', '2020-10-22 03:14:15'),
(4, 'Ita Megawati', 'B Inggris', NULL, 1, '200000', '', '09081992', '2020-10-22 03:33:18', '2020-10-22 03:33:18'),
(5, 'Titis', 'IPA', NULL, 1, '111111', '', '18091989', '2020-10-22 03:34:05', '2020-10-22 03:34:05'),
(6, 'Orang Tua', 'Ortu', NULL, 3, 'Ortu', 'Ortu', '0000', '2020-11-22 04:52:54', '2020-11-22 04:52:54'),
(7, 'Ismoyo', 'MAT', NULL, 1, '111000', NULL, '112222', '2020-12-05 06:15:54', '2020-12-05 06:15:54'),
(12, 'admin', 'Admin', NULL, 2, 'Admin', 'Admin', '1000000', '2020-12-05 21:31:53', '2020-12-05 21:31:53');
...
--
-- Indexes for table `teachingjurnal`
--
ALTER TABLE `teachingjurnal`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `uploadlearning`
--
ALTER TABLE `uploadlearning`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `teachingjurnal`
--
ALTER TABLE `teachingjurnal`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `uploadlearning`
--
ALTER TABLE `uploadlearning`
